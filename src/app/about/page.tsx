...
export const metadata: Metadata = {
  title: "About Us | Harris Landscaping & Gardens — South-West Sydney Landscaping Specialists",
  description:
    "With over 15 years of experience, Harris Landscaping & Gardens delivers quality craftsmanship and exceptional results across Campbelltown, Camden, Narellan, Picton, and the wider South-West Sydney region.",
};
  ...
  return (
    <>
      ...
      <AboutValues
        items={[
          {
            title: "Detail-Focused Craftsmanship",
            description:
              "Every edge, joint, and finish is completed to the highest standard. We take pride in the details that make the difference between good and exceptional.",
          },
          {
            title: "Transparent Communication",
            description:
              "From your first quote to final walkthrough, we keep you informed at every stage with clear timelines and no hidden surprises.",
          },
          {
            title: "Local Expertise",
            description:
              "We know South-West Sydney's soil conditions, council requirements, and climate — giving your project the best possible foundation for long-term success.",
          },
        ]}
