...
export const metadata: Metadata = {
  ...
  description:
    'Browse our portfolio of completed landscaping projects across South-West Sydney — paving, turf, retaining walls, decking, and full garden makeovers.',
};
    ...
    <>
      ...
      <GalleryBeforeAfter
        pairs={[
          ...
          { after: '/images/after-4.jpg', label: 'Full Garden Redesign — Picton', before: '/images/before-4.jpg' },
          { after: '/images/after-5.jpg', label: 'Timber Decking Installation — Ingleburn', before: '/images/before-5.jpg' },
        ]}
