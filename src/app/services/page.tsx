...
export const metadata: Metadata = {
  title: "Our Services | Harris Landscaping & Gardens — Paving, Turf, Decking & More",
  description:
    "Explore our full range of landscaping services including paving, turf installation, retaining walls, decking, garden makeovers, and landscaping design across South-West Sydney.",
};
        ...
        items={[
          {
            ...
            title: "Paving",
            imageAlt: "Paving installation by Harris Landscaping in South-West Sydney",
            description:
              "From driveways to entertaining areas, we install durable and stylish pavers using quality materials suited to South-West Sydney conditions.",
          },
          {
            image: "/images/services/turf.jpg",
            title: "Turf Installation",
            imageAlt: "Turf installation by Harris Landscaping in South-West Sydney",
            description:
              "We supply and lay premium turf varieties to give your lawn a lush, even finish — with preparation and grading included for long-term results.",
          },
          {
            image: "/images/services/retaining-walls.jpg",
            title: "Retaining Walls",
            imageAlt: "Retaining wall built by Harris Landscaping in South-West Sydney",
            description:
              "Our retaining walls are engineered for stability and designed for visual appeal, using timber, concrete sleepers, or natural stone to suit your property.",
          },
          {
            image: "/images/services/decking.jpg",
            title: "Decking",
            imageAlt: "Custom decking by Harris Landscaping in South-West Sydney",
            description:
              "Custom-built timber and composite decking that extends your living space outdoors — designed to complement your home and handle the Australian climate.",
          },
          {
            image: "/images/services/garden-makeovers.jpg",
            title: "Garden Makeovers",
            imageAlt: "Garden makeover by Harris Landscaping in South-West Sydney",
            description:
              "Complete garden transformations including planting, mulching, edging, and feature installations — tailored to your lifestyle and aesthetic.",
          },
          {
            image: "/images/services/landscaping-design.jpg",
            title: "Landscaping Design",
            imageAlt: "Landscaping design consultation by Harris Landscaping in South-West Sydney",
            description:
              "Professional design consultation and planning to map out your ideal outdoor space before a single shovel hits the ground.",
          },
        ]}
